...
public class ObjectController {
    ...
    @PostMapping("/objects")
    public APIResponse<ObjectDTO> createFolder(@Valid @RequestBody ObjectRequest request) throws BadRequestException, ForbiddenException, InternalServerException, ResourceNotFoundException {
